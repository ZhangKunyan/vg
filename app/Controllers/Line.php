...
class Line extends BaseController {
	...
	public function pushbygrade() {
		...
		$sql = "select DISTINCT (SELECT college.college_name from tb_colleges college where  college.college_id = c.college) as name ,c.major from tb_colline c where c.year =?  and type =? and c.grade_min <? ";
